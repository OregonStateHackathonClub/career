        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          {currentUsers.map((profile) => {
            ...
            return (
              <div
                key={profile.id}
                className="duration-300 relative bg-primary hover:before:opacity-10 before:pointer-events-none before:absolute before:inset-0 before:bg-white before:opacity-0 border-gray-500 bg-primary text-gray-100 rounded-lg p-6 flex gap-4"
              >
                ...
                <div className="flex-1">
                  ...
                  <a
                    href={`/api/resume-download/${profile.resumePath}`}
                    download
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <button className="rounded-md hover:scale-105 duration-300 border border-white/60 px-4 py-2 mt-4 cursor-pointer">
                      Download Resume
                    </button>
                  </a>
                </div>
